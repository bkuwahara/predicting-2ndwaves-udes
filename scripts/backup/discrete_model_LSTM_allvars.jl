...
ps_ind = pre_train(indicator_network, ps_ind, st_ind, X_ind[:,train_split,:], Y_ind[:,train_split,:], warmup_ind)
ps_stage1 = Lux.ComponentArray(beta = ps_beta, ind=ps_ind)



function solve_system(u0, tspan::Tuple{Int, Int}, p, st_beta, st_ind)
